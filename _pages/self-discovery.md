...
<main id="content">
  ...
  <section class="section">
    <div class="container">
      <h2 class="section-title section-title--left">Self-Discovery</h2>
      ...
      <div class="sd-jump">
        ...
        <a href="#mood-meter">Mood Meter</a>
        <a href="#doorway0">Safety</a>
        <a href="#doorway1">Reparenting</a>
        <a href="#doorway2">Feeling</a>
        <a href="#doorway3">Creativity</a>
        <a href="#doorway4">Identity</a>
        <a href="#doorway5">Being Seen</a>
        <a href="#doorway6">Integration</a>
      </div>
  ...
  <!-- START HERE -->
  <section class="section section--alt" id="start" aria-label="Start here">
    <div class="container">
