...
<section class="start-page">
  ...
  <div class="start-intro">
    <p class="lead">
      You don’t have to sort your whole life out to begin.
    </p>
    ...
    <p>
      Take one small step. Then pause. That is enough.
    </p>
  </div>
  ...
  <div class="start-soft-block">
    <p class="home-kicker">A slower path</p>
    <h2>Want something more structured?</h2>
    <p>
      The <a href="/self-discovery/" class="inline-link">Self-Discovery Path</a>
      is a slower journey through safety, feelings, identity, patterns, and integration.
  ...
  <div class="start-guidance">
    ...
    <ul>
      ...
      <li>Notice what lands in your body: breath, tears, resistance, warmth, tension.</li>
      <li>Take breaks when you feel foggy, tense, or over-stimulated.</li>
      <li>Bring anything important into therapy, journaling, or trusted conversation.</li>
    </ul>
